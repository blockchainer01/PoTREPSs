...
'''
Sampling and Actuator Layer (SAL) code 

SAL receives the control signal u (ts) from DRL and sends it to the device. 
...
THIRD_LAYER_IP = local_ip  #get local ip
THIRD_LAYER_PORT = local_port # get local port  
