...
'''
Delay Relay Layer (DRL) Code

There are 7 nodes in this DRL layer, 
which are used to receive control signals u 
from SPC and distribute them to 5 PLM nodes. 
Each DRL node receives signals from 5 PLM nodes, 
...
SECOND_LAYER_IP = local_ip
SECOND_LAYER_PORT = local_port  # 示例中的端口，每个第二层节点需要不同的端口  
...
#Method for combining data from 5 PLM nodes and making them consensus
