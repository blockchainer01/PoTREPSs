...
MODULES         = rt_matrx.c rt_printf.c rt_logging.c asyncip_sl_1_sm_ip_test_data.c asyncip_sl_1_sm_ip_test_offsets.c rtGetInf.c rtGetNaN.c rt_nonfinite.c OP_SEND.c sfun_gen_async_ctrl.c sfun_recv_async.c sfun_send_async.c
