function [M,all_choose] = MM4(attack_probability)
% calculate matrix M
...
all_node5=[1 1 1 1 1 0 0];
choose5=unique(perms(all_node5),'rows');
all_node6=[1 1 1 1 1 1 0];
choose6=unique(perms(all_node6),'rows');
choose7=[1 1 1 1 1 1 1];
all_choose=[choose5;choose6;choose7];
% clear all_node5 choose5 all_node6 choose6 choose7
M=zeros(29,29);
for sys=1:29 
    % the action of the system
    sys_choose=all_choose(sys,:);
    for att=1:29  
        % the action of the attacker
        att_choose=all_choose(att,:);
